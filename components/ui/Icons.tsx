// Inline SVG icons. Brand glyphs use simple-icons path data; UI glyphs use
// simple line/solid shapes. All inherit color via `currentColor`.
...
export function AppleMusicIcon(props: IconProps) {
  // Generic music-note glyph (Apple Music link).
  return (
    <Svg {...props}>
      <path d="M21 3v13.5a3.5 3.5 0 1 1-2-3.163V6.82l-9 1.8v9.88a3.5 3.5 0 1 1-2-3.163V5.18a1 1 0 0 1 .804-.98l11-2.2A1 1 0 0 1 21 3z" />
    </Svg>
  );
}

export function IHeartIcon(props: IconProps) {
  // Generic heart glyph (iHeartRadio link).
  return (
    <Svg {...props}>
